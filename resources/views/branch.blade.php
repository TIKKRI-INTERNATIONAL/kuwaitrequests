                        ...
                        <form novalidate="novalidate" data-wizard-form="1">
                            ...
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">BRANCH NAME</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Employee Name">
                                </div>
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Name" class="text-primary fs-10 fw-bold">EMAIL</label>
                                    <input class="form-control rounded-2 py-3" type="phone" placeholder="Email Address">
                                </div>
                              </div>
                ...
                <div class="card-body bg-body-tertiary">
                  ...
                  <table class="table table-borderless fs-10 mb-0 text-start mb-3">
                    ...
                    <tr class="border-bottom">
                      <th class="ps-0"><div class="text-black fw-bold fs-9 ">Feyaa kw - Hawallli</div>
                        <div class="bold">52222354</div>
