                                                        ...
                                                        <div class="row gx-2">
                                                            <div class="mb-3 col-sm-6">
                                                                ...
                                                                <input class="form-control rounded-2 py-3"
                                                                    type="name" placeholder="Employee Name">
                                                            </div>
                                                            <div class="mb-3 col-sm-6">
                                                                <label for="Customer Name"
                                                                    class="text-primary fs-10 fw-bold">EMAIL</label>
                                                                <input class="form-control rounded-2 py-3"
                                                                    type="phone" placeholder="Email Address">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-body bg-body-tertiary">
                                                    ...
                                                    <table class="table table-borderless fs-10 mb-0 text-start mb-3">
                                                        ...
                                                        <tr class="border-bottom">
                                                            <th class="ps-0">
                                                                <div class="text-black fw-bold fs-9 ">Feyaa kw -
                                                                    Hawallli</div>
                                                                <div class="bold">52222354</div>
                                                                <div class="text-800 fw-normal fs-11">Hawalli, Block 9,
                                                                    St 231, 7708, Hawalli</div>
                                                            </th>
                                                        ...
                                                        <div class="col-12 col-sm-auto text-center">
                                                            <p class="mb-0 text-600 opacity-85">All Rights Reserved.
                                                                <span class="d-none d-sm-inline-block">| </span><br
                                                                    ...
                                                                    href="#">Delivery Solution Portal</a></p>
                                                        </div>
