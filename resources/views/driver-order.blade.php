          ...
          <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
            <div class="navbar-vertical-content scrollbar">
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                  ...
                  <a class="nav-link" href="driverorders.jsp" role="button">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-flag"></span></span><span class="nav-link-text ps-1">Driver-Dashboard</span></div>
                  </a>
...
<!-- mobile  -->
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand bg-primary terms-sidebar" style="display: none;">
          ...
          <section class="text-center py-0 px-0">
            <div class="container-fluid">
              <div class="row justify-content-center">
                ...
                <iframe class="px-0" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d317893.9737282887!2d-0.11951900000000001!3d51.503186!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604b900d26973%3A0x4291f3172409ea92!2slastminute.com%20London%20Eye!5e0!3m2!1sen!2sus!4v1708672561327!5m2!1sen!2sus" width="1920" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
            </div>
          </section>
                    ...
                    <div class="card-body position-relative">
                      <div class="row flex-center mb-2">
                        ...
                        <div class="col-auto bg-secondary rounded-3 ms-2">
                          <h5 class="py-2 text-white fs-7">10</h5>
                        </div>
                        <div class="col-auto fs-10 text-600"><span class="mb-0 undefined fs-6">Pending</span> </div>
                      </div>
                      <div class="display-4 fs-8 mb-2 fw-normal font-sans-serif text-secondary pt-3">No Order Show here</div>
                    </div>
				 ...
				 <div class="card overflow-hidden rounded-4" style="min-width: 12rem">
                    <div class="card-body position-relative">
                      <div class="row flex-center mb-2">
                        ...
                        <div class="col-auto fs-10 text-600"><span class="mb-0 undefined fs-6">En Route</span> </div>
                      </div>
                      <div class="display-4 fs-8 mb-2 fw-normal font-sans-serif text-secondary pt-3">No Order Show here</div>
                    </div>
                  </div>
                  ...
                  <div class="card overflow-hidden rounded-4" style="min-width: 12rem">
                    <div class="card-body position-relative">
                      <div class="row flex-center mb-2">
                        ...
                        <div class="col-auto fs-10 text-600"><span class="mb-0 undefined fs-6">Completed</span> </div>
              ...
              <div class="row mt-6">
                <div class="col-lg-3">
                  <div class="card card-span h-100 rounded-4">
                    <div class="card-span-img"><h5 class="py-2 text-black fs-7">10</h5></div>
                      ...
                      <div class="card">
                        <div class="card-header bg-success d-flex flex-between-center text-start">
                          <table class="table table-borderless fs-10 mb-0 text-start">
                            <tr >
                              <th class="ps-0 py-0 text-white"><div class=" fw-normal fs-11"></div>
                                <h5 class="mb-0 text-white">Failed</h5>
                              </th>
                              <th class="pe-0 text-end py-0 text-white">
                                <a class=" btn-sm text-white" href="driverorders.jsp"><span class="fas fa-pencil-alt text-white text-end"></span> Edit</a>
                                <a class=" btn-sm text-white" href="driverorders.jsp"><span class="far fa-address-book text-white text-end"></span> Details</a>
                              </th>
                            </tr>
                          </table>
                        </div>
                        <div class="card-body">
                          <table class="table table-borderless fs-10 mb-0 text-start">
                            <tr class="border-bottom">
                              <th class="ps-0 pt-0"><div class="text-400 fw-normal fs-11">An Hour ago</div>
                                <div class="bold">Name 01 </div>
                                <div class="text-800 fw-normal fs-11"><span class="fas fa-phone-alt text-success"></span> 0915286357</div>
                              </th>
                              <th class="pe-0 text-end pt-0"> <div class="text-black bold"> 268974563324</div>  <div>sample</div></th>
                            </tr>
                            <tr>
                              <th class="ps-0 pb-0">30654<div class="text-400 fw-normal fs-11">no extra notes</div>
                              </th>
                              <th class="pe-0 text-end pb-0">
                                <div class="text-400 fw-normal fs-11">Paid</div>
                                <div class="bold text-black">12.00 <span class="fw-normal">KWD</span></div></th>
                            </tr>
                          </table>
                        </div>
                      </div>
