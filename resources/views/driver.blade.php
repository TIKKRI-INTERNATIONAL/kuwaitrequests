              ...
              <div class="card shopping-cart-bar-min-height h-100">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <a class="btn btn-primary d-block w-100" href="driver"><span class="fas fa-pencil-alt"></span>New Driver</a>
                  </div>
                </div>
              ...
              <div class="card h-100">
                ...
                <div class="card-body bg-body-tertiary">
                  ...
                  <table class="table table-borderless fs-10 mb-0 text-start mb-3">
                    ...
                    <a class="btn btn-falcon-default btn-sm text-600" href="driver"><span class="fas fa-pencil-alt"></span>Edit</a>
                  </div></div></th>
                    </tr>
