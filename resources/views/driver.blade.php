              ...
              <div class="card shopping-cart-bar-min-height h-100">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <a class="btn btn-primary d-block w-100" href="driver.jsp"><span class="fas fa-pencil-alt"></span>New Driver</a>
                  </div>
                </div>
                        ...
                        <form novalidate="novalidate" data-wizard-form="1">
                            ...
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">DRIVER NAME</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="DRIVER NAME">
                                </div>
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Name" class="text-primary fs-10 fw-bold">DRIVER MOBILE NUMBER</label>
							   ...
							   <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">CIVIL ID NUMBER</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="CIVIL ID NUMBER">
                                </div>
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Name" class="text-primary fs-10 fw-bold">VEHICLE LICEN PLATE</label>
                                    <input class="form-control rounded-2 py-3" type="phone" placeholder="CAR PLATE NUMBER">
                                </div>
                              </div>

							  <div class="row gx-2">
                                    <div class="mb-3 col-sm-8">
                                        <label for="Customer Name" class="text-primary fs-10 fw-bold">VEHICLE TYPE</label>
                                        <ul class="nav nav-pills mb-3"  >
                                            <li class="nav-item border" role="presentation"><button class="nav-link active"  data-bs-toggle="pill" type="button" role="tab" aria-selected="true"><span class="d-md-inline-block py-2">CAR</span></button></li>
                                            <li class="nav-item border" role="presentation"><button class="nav-link"  data-bs-toggle="pill"  type="button" role="tab" aria-selected="false"><span class="d-md-inline-block  py-2">MOTER CYCLE</span></button></li>
                                            <li class="nav-item border" role="presentation"><button class="nav-link"  data-bs-toggle="pill" type="button" role="tab" aria-selected="false"><span class=" d-md-inline-block  py-2">OTHER</span></button></li>
                  ...
                  <table class="table table-borderless fs-10 mb-0 text-start mb-3">
                    ...
                    <tr class="border-bottom">
                      <th class="ps-0"><div class="text-black fw-bold fs-9 ">Sameer</div>
                        <div class="bold">Toyota Corolla</div>
                        <div class="text-800 fw-normal fs-11"> Licen Plact 11-222545</div>
                      </th>
                      <th class="pe-0 text-end "><div class="text-success bold fs-6"> <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <a class="btn btn-falcon-default btn-sm text-600" href="driver.jsp"><span class="fas fa-pencil-alt"></span>Edit</a>
                  </div></div></th>
                    </tr>
