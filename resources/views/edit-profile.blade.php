          ...
          <div class="row  rounded-2">
            ...
            <div class="col-lg-6 col-xl-12 col-xxl-8 h-100 pt-5">
                <div class="d-flex mb-4"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-spinner"></i></span>
                  <div class="col">
                    <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Edit Profile</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
                        ...
                        <form novalidate="novalidate" data-wizard-form="1">
                            ...
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">MERCHANT NAME</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Merchan Name">
                                </div>
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Name" class="text-primary fs-10 fw-bold">LEGAL NAME</label>
                                    <input class="form-control rounded-2 py-3" type="phone" placeholder="Legal Name">
                                </div>
                              </div>
								...
								<button class="btn btn-primary d-block w-100" type="submit">Address</button>
								...
								<button class="btn btn-primary d-block w-100" type="submit">Address</button>
								 ...
								 <div class="mb-3 col-sm-6">
<label for="Customer Phone" class="text-primary fs-10 fw-bold">CONTRACT PHOTO</label>
								<div><form action="">  <input type="file" id="myFile" name="filename"> </div> </form>
								<label for="Customer Phone" class="text-primary fs-10 fw-bold">SIGNATORY DOCUMENT</label>
								<div><form action="">  <input type="file" id="myFile" name="filename"> </div> </form>
                                </div>

								 <div class="mb-3 col-sm-6">
<label for="Customer Phone" class="text-primary fs-10 fw-bold">ARTICLESOFASSOCIATION
</label>
								<div><form action="">  <input type="file" id="myFile" name="filename"> </div> </form>
								<label for="Customer Phone" class="text-primary fs-10 fw-bold">LICENCEPHOTO</label>
								<div><form action="">  <input type="file" id="myFile" name="filename"> </div> </form>
                                </div>
                              ...
                              <div class="mb-3">
                                <label for="Order Number" class="text-primary fs-10 fw-bold">Note/ Details</label>
                  ...
                  <div class="card-footer bg-body-tertiary">
                    <div class="px-sm-3 px-md-5">
                      <ul class="pager wizard list-inline mb-0">
                        ...
                        <li class="next" ><button class="btn btn-primary px-2 px-sm-4 py-2 rounded-5 fs-8" type="submit" >Edit<span class="fas fa-chevron-right ms-2" data-fa-transform="shrink-3" > </span></button></li>
                      </ul>
                    </div>
                  </div>
                </div>
