                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                            ...
                                            <div class="list-group"><a
                                                ...
                                                <a class="list-group-item list-group-item-action"
                                                    href="employee">Manage Employee</a>
                                                <a class="list-group-item list-group-item-action"
                                                    href="driver">Manage Driver</a>
                                                <a class="list-group-item list-group-item-action"
                                                    href="branch">Manage Branches</a>
                                                <a class="list-group-item list-group-item-action"
                                                    ...
                                                    <form method="POST" action="{{ route('employee.store') }}">
                                                        ...
                                                        <div class="row gx-2">
                                                            ...
                                                            <div class="mb-3 col-sm-6">
                                                                ...
                                                                <input class="form-control rounded-2 py-3"
                                                                    type="phone" placeholder="" name="email"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="row gx-2">
                                                        ...
                                                        <div class="row gx-2">
                                                            <div class="mb-3 col-sm-8">
                                                                <label for="role"
                                                                    class="text-primary fs-10 fw-bold">Role</label>
                                                            ...
                                                            <div class="mb-3 col-sm-4">
                                                                <div class="mb-3"><label
                                                                    ...
                                                                    <select class="form-select rounded-2 py-3"
                                                                        name="branch" id="bootstrap-wizard-gender">
