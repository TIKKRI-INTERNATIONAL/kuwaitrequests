          ...
          <div class="row  rounded-2">
            ...
            <div class="col-lg-6 col-xl-12 col-xxl-8 h-100 pt-5">
                <div class="d-flex mb-4"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-spinner"></i></span>
                  <div class="col">
                    <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">New Order</span><span class="border position-absolute top-50 translate-middle-y w-100 start-0 z-n1"></span></h5>
                ...
                <div class="card theme-wizard mb-5">
                  <div class="card-header bg-body-tertiary pt-3 pb-2">
                    <ul class="nav justify-content-between nav-wizard">
                      <li class="nav-item"><a class="nav-link active fw-semi-bold" href="#bootstrap-wizard-tab1" data-bs-toggle="tab" data-wizard-step="1"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-lock"></span></span></span><span class="d-none d-md-block mt-1 fs-10">Customer Infomation</span></a></li>
                      <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-tab2" data-bs-toggle="tab" data-wizard-step="2"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-user"></span></span></span><span class="d-none d-md-block mt-1 fs-10">Address Details</span></a></li>
                      <li class="nav-item"><a class="nav-link fw-semi-bold" href="#bootstrap-wizard-tab4" data-bs-toggle="tab" data-wizard-step="4"><span class="nav-item-circle-parent"><span class="nav-item-circle"><span class="fas fa-thumbs-up"></span></span></span><span class="d-none d-md-block mt-1 fs-10">Order Done</span></a></li>
                    </ul>
                  </div>
                    ...
                    <div class="tab-content">
                        ...
                        <form novalidate="novalidate" data-wizard-form="1">
                            ...
                            <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="+965 1234 5678">
                                </div>
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Name" class="text-primary fs-10 fw-bold">Customer Name</label>
                                    <input class="form-control rounded-2 py-3" type="phone" placeholder="Customer Name">
                                </div>
                              </div>
								...
								<div class="row gx-2">
                                    <div class="mb-3 col-sm-8">
                                        ...
                                        <ul class="nav nav-pills mb-3"  >
                                            <li class="nav-item border" role="presentation"><button class="nav-link active"  data-bs-toggle="pill" type="button" role="tab" aria-selected="true"><span class="d-md-inline-block py-2">Cash on delivery</span></button></li>
                                            <li class="nav-item border" role="presentation"><button class="nav-link"  data-bs-toggle="pill"  type="button" role="tab" aria-selected="false"><span class="d-md-inline-block  py-2">Paid</span></button></li>
                                            <li class="nav-item border" role="presentation"><button class="nav-link"  data-bs-toggle="pill" type="button" role="tab" aria-selected="false"><span class=" d-md-inline-block  py-2">Payment Link</span></button></li>
                                          </ul>
                                    </div>
                                    <div class="mb-3 col-sm-4">
                                        <label for="Customer Name" class="text-primary fs-10 fw-bold">Amount</label>
                                        <input class="form-control rounded-2 py-3" type="name" placeholder="0.0000">
                                    </div>
                                  </div>

								  <div class="mb-3"><label class="form-label text-primary fs-10 fw-bold" for="bootstrap-wizard-gender">Vehicle Type</label>
                                <select class="form-select rounded-2 py-3" name="gender" id="bootstrap-wizard-gender">
                                  <option value="">Select your vehicle</option>
                                  <option value="Male">Car</option>
                                  <option value="Female">Motocycle</option>
                                  <option value="Other">Other</option>
                                </select></div>

                              <div class="mb-3">
                                <label for="Order Number" class="text-primary fs-10 fw-bold">Order Number/ Details</label>
                                <input class="form-control rounded-2 py-3" type="text" placeholder="Order Number"></div>
                          ...
                          <div class="form-check">
                            ...
                            <label class="form-check-label" for="bootstrap-wizard-wizard-checkbox">I accept the <a href="#!">terms </a>and <a href="#!">privacy policy</a></label></div>
                        </form>
                      ...
                      <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-tab2" id="bootstrap-wizard-tab2">
                        ...
                        <form data-wizard-form="2">
                         <div class="row gx-2">
                          <div class="mb-3 col-sm-6"><label class="form-label " for="bootstrap-wizard-gender">Area</label>
                            <select class="form-select rounded-2 py-3" name="gender" id="bootstrap-wizard-gender">
                              <option value="">Select your Area ...</option>
                              <option value="Male">Salmiya</option>
                              <option value="Female">Kuwait City</option>
                              <option value="Other">Hawally</option>
                            </select>
							</div>

							 <div class="mb-3 col-sm-6"><label class="form-label " for="bootstrap-wizard-gender">Block</label>
                            <select class="form-select rounded-2 py-3" name="gender" id="bootstrap-wizard-gender">
                              <option value="">Select your Block ...</option>
                              <option value="Male">Block 1</option>
                              <option value="Female">Block 2</option>
                              <option value="Other">Block 3</option>
                            </select></div>
							</div>

                          <div class="mb-3"><label class="form-label " for="bootstrap-wizard-wizard-phone">Street</label><input class="form-control rounded-2 py-3" type="text" name="phone" placeholder="Street" id="bootstrap-wizard-wizard-phone"></div>
                          <div class="row gx-2">
                                <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">Building Number or Name</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Building Number or Name">
                                </div>

                             <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">Jedda</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Jedda">
                                </div>

								    <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">Apratment / office</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Apratment or Office">
                                </div>

                             <div class="mb-3 col-sm-6">
                                    <label for="Customer Phone" class="text-primary fs-10 fw-bold">Floor</label>
                                    <input class="form-control rounded-2 py-3" type="name" placeholder="Floor">
                                </div>

						  <div class="mb-3"><label class="form-label" for="bootstrap-wizard-wizard-datepicker">Notes</label><input class="form-control rounded-2 py-3 datetimepicker" type="text" placeholder="Note / Instruction" id="bootstrap-wizard-wizard-datepicker"></div>
                      ...
                      <div class="tab-pane text-center px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-tab4" id="bootstrap-wizard-tab4">
                        ...
                        <p>Now you can create order</p><a class="btn btn-primary px-5 my-3" href="#">Create Order</a>
                      </div>
                  ...
                  <div class="card-footer bg-body-tertiary">
                    <div class="px-sm-3 px-md-5">
                      <ul class="pager wizard list-inline mb-0">
                        ...
                        <li class="next"><button class="btn btn-primary px-2 px-sm-4 py-2 rounded-5 fs-8" type="submit">Next Step<span class="fas fa-chevron-right ms-2" data-fa-transform="shrink-3"> </span></button></li>
                      </ul>
                    </div>
                  </div>
                </div>
