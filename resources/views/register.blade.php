                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card card rounded-5">
                        ...
                        <div class="card-body p-4 p-sm-5">
                            <a class="d-flex flex-center mb-1" href=" index.html"><img class="me-2"
                        ...
                        @endif
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" type="text" name="name" autocomplete="on"
                                        placeholder="Name">
                                </div>
                                <div class="mb-2">
                                    <label for="email" class="text-primary fs-10 fw-bold">Email address</label>
                                ...
                                <div class="row gx-2">
                                    ...
                                    <div class="mb-3 col-sm-6">
                                        <label for="password_confirmation" class="text-primary fs-10 fw-bold">Confirm
                                            Password</label>
                                ...
                                <div class="col-auto fs-10 text-600"><span class="mb-0 undefined">Have an
                                        account?</span> <span><a href="{{ route('log') }}">Login</a></span></div>
                            </form>
