                                ...
                                <tr class="border-bottom">
                                    ...
                                    <th class="ps-0 pt-0">
                                        <div class="text-black fw-bold fs-9 ">
                                            <div>DON’T HAVE YOUR OWN FLEET?
                                                DELIVER YOUR PRODUCTS WITH KUWAIT REQUESTS NOW!
                                            </div>

                                    </th>
                                    <th class="pe-0 text-end ">
                                        <div class="text-success bold fs-6"><a class="btn btn-primary d-block w-100"
                                                href="setting"><span>Subscribe</span></a></div>
                                    </th>
                                </tr>
                    ...
                    <div class="row justify-content-between fs-10">
                        <div class="col-12 col-sm-auto text-center">
                            <p class="mb-0 text-600 opacity-85">All Rights Reserved. <span
                                    ...
                                    class="text-white opacity-85" href="#">Delivery Solution
                                    Portal</a></p>
                        </div>
