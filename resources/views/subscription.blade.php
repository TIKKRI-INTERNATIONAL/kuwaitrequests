            ...
            <div class="col-xxl-12 col-md-12 pt-3">
              <div class="card shopping-cart-bar-min-height h-100">
                <div class="card-header d-flex flex-between-center">
                  <h3 class="mb-0 text-primary fw-bold">Subscriptions Plan</h3>
                    ...
                    <div class="card-body pb-0 pt-2">
                      <table class="table table-borderless fs-10 mb-0 text-start">
                        <tr class="border-bottom">
                          ...
                          <th class="ps-0 pt-0"><div class="text-black fw-bold fs-9 "> <div>DON’T HAVE YOUR OWN FLEET?
DELIVER YOUR PRODUCTS WITH KUWAIT REQUESTS NOW!</div>

                          </th>
                          <th class="pe-0 text-end "><div class="text-success bold fs-6"><a class="btn btn-primary d-block w-100" href="Setting.jsp"><span >Subscribe</span></a></div></th>
                        </tr>
