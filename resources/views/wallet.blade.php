  ...
  <div class="col-lg-9 px-lg-0">
    ...
    <div class="row ms-lg-0 pe-lg-2">
              ...
              <div class="card shopping-cart-bar-min-height h-100">
                <div class="card-header d-flex flex-between-center">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <a class="btn btn-falcon-default btn-sm text-600" href="#"><span class="fas fa-pencil-alt"></span></a>
                  </div>
                </div>
            ...
            <div class="col-lg-6 pt-3">
              <div class="card h-100">
                <div class="card-body px-4 py-3 my-2">
                  <h4 class="text-800">Balance</h4>
                  <div class="alert alert-success mt-3">
                    <h3 class="mb-0 fs-4 fw-bold text-center">3.000 KD
                    </h3>
                  </div>
            ...
            <div class="col-lg-6 pt-3">
              <div class="card h-100">
                <div class="card-body px-4 py-3 my-2">
                  <h4 class="text-800">Pending Payments</h4>
              ...
              <div class="card h-100">
                ...
                <div class="card-body bg-body-tertiary">
                    ...
                    <div class="card-body pb-0 pt-1">
                      <table class="table table-borderless fs-10 mb-0 text-start">
                        <tr class="border-bottom">
                          ...
                          <th class="ps-0 pt-0"><div class="text-black fw-bold fs-9 ">100000001</div>
                            <div class="bold">Merchant top up</div>
                            <div class="text-800 fw-normal fs-11"> 01/02/2024 02:25:53</div>
                          </th>
                          <th class="pe-0 text-end "><div class="text-success bold fs-6"> +5.000KWD</div></th>
                        </tr>
                      </table>
                    </div>
                  </div>
                  ...
                  <table class="table table-borderless fs-10 mb-0 text-start mb-3">
                    ...
                    <tr class="border-bottom">
                      <th class="ps-0"><div class="text-black fw-bold fs-9 ">100000001</div>
                        <div class="bold">Merchant top up</div>
                        <div class="text-800 fw-normal fs-11"> 01/02/2024 02:25:53</div>
                      </th>
                      <th class="pe-0 text-end "><div class="text-success bold fs-6"> +5.000KWD</div></th>
                  ...
                  <button class="btn btn-primary d-block w-100" type="submit">Topup</button>
                  </div>
              </div>
            </div>
